      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Les instructions pour les exercices.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Exercices pour apprendre à utiliser un pool de clients.
          </p>
        </Link>
        <Link
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Exercices pour apprendre à utiliser SQL natif.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            Exercice pour debuter avec Drizzle.
          </p>
        </Link>
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>CRUD</p>
        </Link>
        <Link
