...
((SELECT id FROM users WHERE name = 'Alice'), 1000.00),
((SELECT id FROM users WHERE name = 'Alice'), 250.00),
((SELECT id FROM users WHERE name = 'Bob'), 1500.00),
((SELECT id FROM users WHERE name = 'Bob'), 500.00);
